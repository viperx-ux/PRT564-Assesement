...
in a crash and the number of injuries reported?
"""
...
plt.savefig("fig11_actual_vs_predicted_multiple.png", dpi=300, bbox_inches="tight")
plt.close()
...
plt.savefig("fig12_residual_plot_multiple.png", dpi=300, bbox_inches="tight")
plt.close()
